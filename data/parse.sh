...
python parse.py --dir_path diam --num_contexts 20 $1
python parse.py --dir_path stac --num_contexts 20 $1
python parse.py --dir_path molweni --num_contexts 14 $1

python parse_test.py --dir_path diam --num_contexts 20 --mode dev $1
python parse_test.py --dir_path diam --num_contexts 20 $1
